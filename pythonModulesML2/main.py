...
Keep each exercise file inside its corresponding ex0 to ex7 folder.
"""
...
def test_ft_exercise(exercise_file_name, exercise_number):
    ...
    For example: test_ft_exercise("ft_plot_area", 2) will:
    ...
    try:
        ...
        print(
            f"""   Make sure your file exists inside the
            ex{exercise_number} folder"""
        )
